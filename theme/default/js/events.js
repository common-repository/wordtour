				...
				$("a[rel=#wt-venue-overlay]").each(function(i) {
					$(this).overlay({ 
						...
						onBeforeLoad : function(){
							...
							$("#wt-venue-header").html(elem.next().val());
							$("#wt-venue-details").html(elem.next().next().next().next().val());
						},
						onLoad: function() {
							var elem = this.getTrigger();
							var countryCode = elem.next().next().val();
							var address = elem.next().next().next().val();
